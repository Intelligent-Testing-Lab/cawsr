# FORK
This ROS package is modified to integrate the autoware package with [autoware_scenario_runner](https://github.com/Intelligent-Testing-Lab/autoware_scenario_runner).
