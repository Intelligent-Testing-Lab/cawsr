...
class RouteNode:
    ...
    def __init__(self, autoware_state, node) -> None:
        ...
        logger.info(f"Service '{self.set_route_points_service_name}' available.")

        logger.info(f"Waiting for '{self.clear_route_service_name}' service...")
    ...
    def clear_route_response_callback(self, future):
        ...
        try:
            ...
            if response.status.success:
                ...
                logger.warn(f"Failed to clear route: {response.status.message}")
